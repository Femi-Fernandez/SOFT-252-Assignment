 ...
 * @author afernandez
 */
public class PatientViewHistory extends javax.swing.JFrame {

    /**
     * Creates new form PatientViewHistory
     */
    static String currentID;
    public PatientViewHistory(String userID) {
        initComponents();
        this.currentID = userID;
        AppointmentFillInfo();
        prescriptionFillInfo();
    }
    public void AppointmentFillInfo()
    {
        ...
        for (int i = 0; i < SystemDatabase.appointmentArray.size(); i++) {
            ...
            {
                TxtAppointmentInfo.setText(TxtAppointmentInfo.getText() +"\n"
                        + SystemDatabase.appointmentArray.get(i).getDate()+"\n"
                + SystemDatabase.appointmentArray.get(i).getDocID()+"\n"
    ...
    public void prescriptionFillInfo()
    {
        ...
        for (int i = 0; i < SystemDatabase.prescriptionArray.size(); i++) {
            ...
            {
                TxtPrescriptionInfo.setText(TxtPrescriptionInfo.getText()+"\n"
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Prescription history");

        TxtAppointmentInfo.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientViewHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
